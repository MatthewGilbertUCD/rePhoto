...
The *maptools* and *rgdal* R packages and dependency package *sp* are needed to output KML files, but not to run the other functions. The rePhoto installation may install these packages, if not you can do it yourself:

install.packages("https://cran.r-project.org/src/contrib/maptools_1.1-1.tar.gz", repos=NULL)  
install.packages("https://cran.r-project.org/src/contrib/rgdal_1.5-23.tar.gz", repos=NULL)
