...
We can replot the analysis, this time using the *extrapoints* input to add a known location, in this case a distinctive feature of the lake shore. *title* allows us to annotate the plot with a unique label.
```{r new4}
